...
/stranger character_bind character_name:Эрин character_id:pc_erin_02
/stranger status
```

В активной сцене бот архивирует все сообщения, но отвечает только на упоминание или reply на его сообщение.
